...
## DB Assignments  [![Build Status](https://travis-ci.org/yauhenikh/db-assignments.svg?branch=master)](https://travis-ci.org/AisBrestEdu/db-assignments)
...
```
* Open https://github.com/yauhenikh/db-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
